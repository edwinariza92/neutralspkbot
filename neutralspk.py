...
bb_mult = 2.8  # Multiplicador por defecto para Bandas de Bollinger
atr_length = 4  # Periodo por defecto para ATR
ma_trend_length = 50  # Periodo por defecto para MA de tendencia
tp_multiplier = 4.2  # Multiplicador por defecto para Take Profit
